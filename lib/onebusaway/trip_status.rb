...
module OneBusAway
  class TripStatus < Base
    ...
    def initialize(attributes)
      ...
      @last_known_location = Location.new attributes['lastKnownLocation']
      @last_known_orientation = attributes['lastKnownOrientation']
      @last_uodate_time = get_time attributes['last_update_time']
      @next_stop = attributes['nextStop']
      @next_stop_time_offset = attributes['nextStopTimeOffset']
      @orientation = attributes['orientation']
      @phase = attributes['phase']
      @position = Location.new attributes['position']
      ...
      @situation_id = attributes['situationId']
